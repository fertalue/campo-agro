                    ...
                    {filteredDetalle.map(c => {
                      ...
                      return isEdit ? (
                        ...
                        <tr key={c.id}>
                          ...
                          <td style={{ fontFamily:'monospace', whiteSpace:'nowrap', color:'var(--musgo)', fontSize:11 }}>{c.precio_unitario ? 'U$S '+Number(c.precio_unitario).toLocaleString('es-AR',{minimumFractionDigits:4,maximumFractionDigits:4}) : '\u2014'}</td>
